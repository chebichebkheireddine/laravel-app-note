<header
    class="flex items-center justify-between mt-4 px-6 py-3 md:py-4 shadow max-w-5xl rounded-full mx-auto w-full bg-white"
    dir="rtl">
    <div class="text-base font-bold text-blue-900">مديرية التربية <br> لولاية المنيعة </div>
    <nav id="menu"
        ...
        <a class="hover:text-indigo-600" href="{{ route('home') }}">
            الصفحة الرئيسية
        </a>
        <a class="hover:text-indigo-600" href="{{ route('notes.index') }}">
            مصلحة الموظفين </a>
